...
EXCHANGE_CLOSED_ERROR_SUBSTRINGS = ('net predlozhenij v stakane', 'нет предложений в стакане', 'market is closed', 'instrument is not available for trading', 'торги по инструменту закрыты')
